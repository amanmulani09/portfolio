...
Frontend-only portfolio for Aman Mulani, AI Engineer focused on production LLM products, agents, RAG, and full-stack systems.
...
- Production AI system map in the hero.
- Four case-study routes: AI Shopping Assistant, RAG Knowledge Assistant, Chitra.ai, and Codo.
